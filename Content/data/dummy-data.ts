...
export const CATEGORIES = [
  ...
  // new Lesson('I', 'Lesson 9', 'Will come', 0),
  // new Lesson('J', 'Lesson 10', 'Will come', 0),
  // new Lesson('K', 'Lesson 11', 'Will come', 0),
  // new Lesson('L', 'Lesson 12', 'Will come', 0),
  // new Lesson('M', 'Lesson 13', 'Will come', 0),
  // new Lesson('N', 'Lesson 14', 'Will come', 0),
  // new Lesson('O', 'Lesson 15', 'Will come', 0),
  // new Lesson('P', 'Lesson 16', 'Will come', 0),
];
